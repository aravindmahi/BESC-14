...
\begin{figure*}
	...
	\subfloat[Day 0]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/caprilesWordCloud1.png}
		\label{fig:wordCloud1}
	} 
	\subfloat[Day 6]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/caprilesWordCloud2.png}
		\label{fig:wordCloud2}
	} \\
	\noindent 
	\subfloat[Day 15]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/caprilesWordCloud3.png}
		\label{fig:wordCloud3}
	}
	\subfloat[Day 30]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/caprilesWordCloud4.png}
...
\begin{figure*}[scale=0.75]
	...
	\subfloat[Mexico]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/mexicoWordCloud.png}
		\label{fig:mexicowordCloud}
	} 
	\subfloat[Paraguay]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/paraguayWordCloud.png}
		\label{fig:paraguaywordCloud}
	} \\
	\noindent 
	\subfloat[Honduras]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/hondurasWordCloud.png}
		\label{fig:honduraswordCloud}
	}
	\subfloat[Ecuador]
	{
		\includegraphics[width=0.5\textwidth, height=0.30\textheight]{support_files/ecuadorWordCloud.png}
