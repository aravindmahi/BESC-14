...
\begin{figure*}
	...
	\subfloat[Day 15]
	{
		\includegraphics[width=0.4\textwidth, height=0.12\textheight]{support_files/caprilesWordCloud3.png}
		\label{fig:wordCloud3}
	}
	\subfloat[Day 30]
	{
		\includegraphics[width=0.4\textwidth, height=0.12\textheight]{support_files/caprilesWordCloud4.png}
