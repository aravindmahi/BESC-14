...
\begin{figure*}
	...
	\subfloat[Day 0]
	{
		\includegraphics[width=0.4\textwidth, height=0.14\textheight]{support_files/caprilesWordCloud1.png}
		\label{fig:wordCloud1}
	} 
	\subfloat[Day 6]
	{
		\includegraphics[width=0.4\textwidth, height=0.14\textheight]{support_files/caprilesWordCloud2.png}
		\label{fig:wordCloud2}
	} \\
	\noindent 
	\subfloat[Day 15]
	{
		\includegraphics[width=0.4\textwidth, height=0.14\textheight]{support_files/caprilesWordCloud3.png}
		\label{fig:wordCloud3}
	}
	\subfloat[Day 30]
	{
		\includegraphics[width=0.4\textwidth, height=0.14\textheight]{support_files/caprilesWordCloud4.png}
